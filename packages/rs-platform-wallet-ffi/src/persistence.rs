...
pub struct FFIPersister {
    ...
    /// was allocated by `persistence_extension_callbacks` through the
    /// `negotiated_extension_slot!` macro in `manager.rs`. This structurally
    /// attests `CORE_SWEEP_REMOVAL`; the legacy changeset
