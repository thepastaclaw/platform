//! FFI binding for `IdentityWallet::token_unfreeze_with_external_signer`.
...
/// Unfreeze the entire frozen balance of `frozen_identity_id`.
#[no_mangle]
#[allow(clippy::too_many_arguments)]
pub unsafe extern "C" fn platform_wallet_token_unfreeze(
    ...
    let option = PLATFORM_WALLET_STORAGE.with_item(wallet_handle, |wallet| {
        ...
        block_on_worker(async move {
            ...
            identity_wallet
                .token_unfreeze_with_external_signer(
                    id,
                    contract_id,
                    token_position,
                    frozen_id,
